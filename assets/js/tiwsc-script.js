jQuery(document).ready(function($) {
    ...
    console.log('tiwsc_ajax:', typeof tiwsc_ajax !== 'undefined' ? tiwsc_ajax : 'undefined');
    ...
    $(document).on('click', '#tiwsc-sidebar-close, #tiwsc-sidebar-overlay', function(e) {
        e.preventDefault();
    ...
    $(document).on('submit', '#tiwsc-sample-form', function(e) {
        ...
        $('#tiwsc-sample-form-result').html('<div style="color:#666;">Bezig met verzenden...</div>');
        ...
        $.post(tiwsc_ajax.ajax_url, formData, function(response) {
            ...
            $('#tiwsc-sample-form-result').html('<div style="color:#008000;font-weight:bold;">' + response + '</div>');
            ...
            console.error('AJAX error:', status, error);
            $('#tiwsc-sample-form-result').html('<div style="color:#d00;">Er is een fout opgetreden. Probeer het opnieuw.</div>');
        });
    });
    ...
    if ($('.tiwsc-open-sidebar-link').length === 0) {
        ...
        console.log('Found', $('.tiwsc-open-sidebar-link').length, 'sidebar open links');
    }
});